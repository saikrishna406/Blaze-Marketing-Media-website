      ...
      >
        <motion.div className="max-w-3xl mx-auto" variants={fadeInUp}>
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Professional video editing services that transform raw footage into compelling, polished visual stories that captivate your audience.
          </motion.p>
          <motion.div 
        ...
        <div className="container mx-auto px-4 text-left flex flex-col md:flex-row items-center gap-8">
          ...
          >
            ...
            <ul className="list-none space-y-4">
              {[
                { icon: '✔️', title: 'Commercial & Promotional Videos', description: 'Eye-catching promotional videos that showcase your products or services and drive conversions.' },
                { icon: '✔️', title: 'Corporate Videos', description: 'Professional corporate videos for training, company culture, investor relations, and more.' },
                { icon: '✔️', title: 'Social Media Content', description: 'Engaging, platform-optimized video content that drives engagement and shares across social channels.' },
                { icon: '✔️', title: 'Motion Graphics Integration', description: 'Custom motion graphics and visual effects that enhance your video content and reinforce your brand.' },
                { icon: '✔️', title: 'Color Grading & Audio Enhancement', description: 'Professional color correction, audio mixing, and sound design to elevate the quality of your videos.' }
              ].map((offer, index) => (
                <motion.li 
                  key={index} 
          ...
          >
            <img src="../src/images/VideoEditing.jpg" alt="Video Editing Services" className="w-full h-auto rounded-lg shadow-lg" />
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12">
            {[
              { number: '78%', text: 'Higher Engagement' },
              { number: '157%', text: 'Increased Social Shares' },
              { number: '43%', text: 'Better Conversion Rates' },
