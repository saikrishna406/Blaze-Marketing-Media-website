...
import { Stars, Cloud, Float, Environment, OrbitControls } from '@react-three/drei';
...
export default function ThreeDRenderportfolio() {
  const projects = [
    {
    ...
    },
    {
      ...
      description: "High-quality product renders for marketing and presentations.",
      thumbnail: "/src/images/ThreeDImage.jpg",
      technologies: ["Blender", "KeyShot", "Product Design"]
    },
    {
      title: "Interior Visualization",
      description: "Stunning interior design visualization and renders.",
      thumbnail: "/src/images/VideoEditing.jpg",
      technologies: ["3ds Max", "V-Ray", "Interior Design"]
    }
  ];
      ...
      <div className="relative h-screen w-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center">
            ...
            >
              Explore our photorealistic 3D renders
            </motion.p>
          </div>
        </div>
      </div>
