...
export default function ThreeDRendersPage() {
  useEffect(() => {
    window.scrollTo({
      top: 0,
      behavior: 'smooth'
      ...
      >
        <motion.div className="max-w-3xl mx-auto" variants={fadeInUp}>
          ...
          <motion.p 
            ...
            variants={fadeInUp}
          >
            Photorealistic 3D renders that showcase products, architecture, and concepts with stunning detail and clarity.
          </motion.p>
          <motion.div 
        ...
        <div className="container mx-auto px-4 text-left flex flex-col md:flex-row items-center gap-8">
          ...
          >
            ...
            <ul className="list-none space-y-4">
              {[
                { icon: '✔️', title: 'Product Rendering', description: 'Showcase your products in photorealistic detail before they\'re manufactured, perfect for marketing materials and presentations.' },
                { icon: '✔️', title: 'Architectural Visualization', description: 'Transform blueprints and floor plans into stunning visual representations of buildings and spaces.' },
                { icon: '✔️', title: 'Interior Design Renders', description: 'Visualize interior spaces with precise lighting, materials, and furnishings to bring design concepts to life.' },
                { icon: '✔️', title: 'Concept Visualization', description: 'Turn abstract ideas into tangible visual assets that help communicate your vision to stakeholders.' },
                { icon: '✔️', title: '360° Virtual Tours', description: 'Create immersive experiences that allow viewers to explore spaces or products from every angle.' }
              ].map((offer, index) => (
                <motion.li 
                  key={index} 
          ...
          >
            <img src="../src/images/ThreeDRenders.jpg" alt="3D Rendering Services" className="w-full h-auto rounded-lg shadow-lg" />
          </motion.div>
        </div>
      </motion.section>
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-12">
            {[
              { number: '60%', text: 'Reduced Production Costs' },
              { number: '85%', text: 'Faster Time to Market' },
              { number: '93%', text: 'Client Approval Rate' },
              { number: '4.8/5', text: 'Average Client Rating' }
            ].map((stat, index) => (
              <motion.div
                key={index}
        ...
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <div className="bg-gray-900/60 p-6 md:p-8 rounded-lg shadow-lg">
              ...
              >
                "The photorealistic renders created by BlazeMarketingMedia helped us secure client approval faster than ever. The quality and attention to detail are unmatched."
              </motion.blockquote>
              <motion.div 
              ...
              >
                Design Director, ArchVision Studios
              </motion.div>
            </div>
          </motion.div>
